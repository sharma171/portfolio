...
const FeaturedWorks = () => {
    const workData = [
        {
            thumb:"http://localhost:3000/public/work/work1.jpg",
        ...
        <div className="workcards">
            ...
            <div className="card-item">
                <div className="card-thumb">
                    <Image src={item.thumb} width={250} height={180} alt="thumbnail" className="thumb-img" />
                </div>
                <div className="card-info">
                    <h3 className="heading">{item.head}</h3>
